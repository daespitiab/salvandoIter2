...
CREATE TABLE H_RESTAURANTES_BAR (ID NUMBER, NOMBRE VARCHAR2 (255 BYTE) NOT NULL, CAPACIDAD NUMBER NOT NULL, TEMATICA VARCHAR2 (255 BYTE), CONSTRAINT H_RESTAURANTES_BAR_PK PRIMARY KEY (ID));
...
CREATE TABLE H_GIMNASIOS (ID NUMBER, NOMBRE VARCHAR2 (255 BYTE) NOT NULL, PRECIO NUMBER NOT NULL, PRECIOADICIONAL NUMBER NOT NULL, CONSTRAINT H_GIMNASIOS_PK PRIMARY KEY (ID));
...
CREATE TABLE H_RESERVACIONES_HOTEL (ID NUMBER, FECHALLEGADA VARCHAR2 (255 BYTE) NOT NULL, FECHAPARTIDA VARCHAR2 (255 BYTE) NOT NULL, NUMEROPERSONAS NUMBER NOT NULL, PLANPAGO NUMBER, ID_SERVICIO NUMBER, CONSTRAINT H_RESERVACIONES_HOTEL_PK PRIMARY KEY (ID));
...
-- Tabla clientesReservas

CREATE TABLE H_CLIENTESRESERVAS (ID NUMBER, NUMDOCUMENTO NUMBER, ID_PLAN NUMBER, ID_RESERVACION_HOTEL NUMBER, ID_RESERVACION_SERVICIOS NUMBER, ID_CUENTA  NUMBER, CONSTRAINT H_CLIENTES_PK PRIMARY KEY (ID, NUMDOCUMENTO));

ALTER TABLE H_CLIENTESRESERVAS ADD CONSTRAINT FK_C_DOC FOREIGN KEY (NUMDOCUMENTO) REFERENCES H_USUARIOS (NUMDOCUMENTO) ENABLE;

ALTER TABLE H_CLIENTESRESERVAS ADD CONSTRAINT FK_C_PLANES FOREIGN KEY (ID_PLAN) REFERENCES H_PLANES (ID) ENABLE;

ALTER TABLE H_CLIENTESRESERVAS ADD CONSTRAINT FK_C_RESERVACIONES FOREIGN KEY (ID_RESERVACION_HOTEL) REFERENCES H_RESERVACIONES_HOTEL (ID) ENABLE;

ALTER TABLE H_CLIENTESRESERVAS ADD CONSTRAINT FK_C_SERVICIOS FOREIGN KEY (ID_RESERVACION_SERVICIOS) REFERENCES H_SERVICIOS_HOTEL (ID) ENABLE;

ALTER TABLE H_CLIENTESRESERVAS ADD CONSTRAINT FK_C_CUENTAS FOREIGN KEY (ID_CUENTA) REFERENCES H_CUENTAS (ID) ENABLE;
...
CREATE TABLE H_HABITACIONES (ID NUMBER, ID_HOTEL NUMBER, ID_TIPO NUMBER, RESERVADA NUMBER NOT NULL, PRECIONOCHE NUMBER NOT NULL, CONSTRAINT H_HABITACIONES_PK PRIMARY KEY (ID));
