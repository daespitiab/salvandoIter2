...
//    }
    ...
    public void adicionarRolDeUsuario( )
    {
    	try 
    	{
    		...
    		String descripcionRol = JOptionPane.showInputDialog (this, "Descripcion del rol?", "Adicionar rol de usuario", JOptionPane.QUESTION_MESSAGE);
    		{  
    			System.out.println("el nombre es "+ "el nombre es "+ nombreRol + "la descripcion es  "+descripcionRol);
    			if (nombreRol != null && descripcionRol!=null){
    				System.out.println("entré");
//    			 
//    				Rol rol=hotelAndes.adicionarRolDeUsuario("Gerente","Gerencia");
        		Rol rol = hotelAndes.adicionarRolDeUsuario(nombreRol, descripcionRol);
        		System.out.println("el id es"+ rol.getId());
        	if (rol == null)
        		{	
        			throw new Exception ("No se pudo crear un rol de usuario con nombre: " + nombreRol+", y descripcion:"+descripcionRol);
        		}
        		String resultado = "En adicionarRolDeUsuario\n\n";
        		resultado += "Rol de Usuario adicionado exitosamente: " + rol;
    			resultado += "\n Operación terminada";
    			panelDatos.actualizarInterfaz(resultado);
    		}
    		else
