...
INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (101, 1, 1, 0, 100000);

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (103, 1, 1, 0, 100000);

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (105, 1, 1, 1, 100000);

-- Doble 

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (202, 1, 2, 0, 200000);

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (204, 1, 2, 0, 220000);

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (206, 1, 2, 0, 190000);

-- Suite

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (313, 1, 3, 0, 400000);

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (414, 1, 3, 0, 500000);

INSERT INTO H_HABITACIONES (ID, ID_HOTEL, ID_TIPO, RESERVADA, PRECIONOCHE) VALUES (515, 1, 3, 1, 550000);
...
INSERT INTO H_RESTAURANTES_BAR (ID, NOMBRE, CAPACIDAD, TEMATICA) VALUES (1, 'Al wok', 50, 'Restaurante oriental');

INSERT INTO H_PRODUCTOS_INSTALACIONES (ID_ITEM, NOMBRE, PRECIO) VALUES (1, 'Vegetales con carne al wok', 15000);
...
INSERT INTO H_RESTAURANTES_BAR (ID, NOMBRE, CAPACIDAD, TEMATICA) VALUES (2, 'Bar oculto', 100, 'Bar de jazz');

INSERT INTO H_PRODUCTOS_INSTALACIONES (ID_ITEM, NOMBRE, PRECIO) VALUES (4, 'Cerveza nacional', 5000);
